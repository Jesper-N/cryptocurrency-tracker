...
export const coins = pgTable(
  "coins",
  {
    ...
    percentChange24h: numeric("percent_change_24h", {
      precision: 20,
      scale: 8,
    }),
    percentChange7d: numeric("percent_change_7d", { precision: 20, scale: 8 }),
    percentChange30d: numeric("percent_change_30d", {
      precision: 20,
      scale: 8,
    }),
    percentChange60d: numeric("percent_change_60d", {
      precision: 20,
      scale: 8,
    }),
    percentChange90d: numeric("percent_change_90d", {
      precision: 20,
      scale: 8,
    }),
...
export const priceHistory = pgTable(
  ...
  (table) => [
    index("price_history_coin_time_idx").on(table.coinId, table.timestamp),
  ],
);
