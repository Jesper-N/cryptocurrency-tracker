...
<div class="flex size-full grow flex-col pb-8 lg:flex-row">
    ...
    >
      <div class="panel-border-b flex flex-col gap-y-6 p-6">
        <div class="flex cursor-default items-baseline gap-x-3 select-none">
          <h1 class="val-technical text-3xl font-bold uppercase">
            {coin.name}
          </h1>
      ...
      <div class="grid grid-cols-2">
        <div class="panel-border-b panel-border-r p-4">
          <div class="lbl-technical mb-2 cursor-default select-none">
            Market Cap
          </div>
        ...
        <div class="p-4">
          ...
          <div class="val-technical font-medium">
            <span class={tone(change90d)}
              >{change90d >= 0 ? "+" : ""}{change90d.toFixed(2)}%</span
            >
          </div>
        </div>
      </div>
  ...
  <div
    use:enter={0.1}
    class="flex w-full flex-col p-4 opacity-0 lg:flex-1 lg:pl-0"
  >
    <div
    ...
    >
      <div class="panel-border-b flex items-end justify-between p-6">
        <div>
          <h2 class="lbl-technical mb-1 cursor-default select-none">
            {coin.name} / USD
          </h2>
          <div
          ...
          <AreaChart
            ...
            props={{
              ...
              xAxis: {
                ...
                classes: {
                  tickLabel:
                    "text-[0.6rem] uppercase tracking-widest fill-muted-foreground",
                },
              },
              yAxis: {
                format: () => "",
